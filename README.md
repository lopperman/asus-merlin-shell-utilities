...
```zsh
 ~ map_macs
Building MAC mapping file...
  Fetching dnsmasq.conf from primary router (10.10.3.1)...
    Found 60 static DHCP entries
  Fetching dnsmasq.leases from primary router...
    Added 1 from leases, updated 0 hostnames
  Fetching infrastructure MACs from routers...
    Querying Primary (10.10.3.1)...
    Querying Mesh1 (10.10.3.2)...
    Querying Mesh2 (10.10.3.3)...
Building MAC mapping file...
  Fetching dnsmasq.conf from primary router (10.10.3.1)...
    Found 60 static DHCP entries
  Fetching dnsmasq.leases from primary router...
